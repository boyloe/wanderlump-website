...
export default function siouxFalls(): ReactElement {
  return (
    <div className="mx-auto max-w-3xl p-4 md:p-0">
      <title>Sioux Falls, South Dakota</title>
      <article>
        ...
        <p className="my-4 font-lato text-xl tracking-wide text-justify">
          Our next stop was to Black Hills, SD, but we had to make a quick trip
        ...
        <p className="my-4 font-lato text-xl tracking-wide text-justify">
          ...
          more time and the weather permits it, you can explore remnants of the
          Queen Bee Mill, bike along the River Greenway, visit the Farmers’
          Market, dine at the Falls Overlook Café, or visit the falls in the
          winter months to see them lit up into a Winter Wonderland.
        </p>
        <img
