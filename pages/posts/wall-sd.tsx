...
export default function wallSD(): ReactElement {
  return (
    <>
      <Head>
        <title>Wall Drug Store</title>
        <meta property="og:title" content="Round Lake, MN" />
        <meta
          property="og:description"
          content="It's A Trap...A Tourist Trap"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://wanderlump.com/posts/wall-sd"
        />
        <meta
          property="og:image"
          content="https://www.wanderlump.com/images/posts/wall-sd/akbar.jpeg"
        />

        <meta property="og:image:type" content="image/jpeg" />
        <meta property="og:image:width" content="400" />
        <meta property="og:image:height" content="300" />
        <meta property="og:image:alt" content="Wall Drug, South Dakota" />
      </Head>
      <div className="mx-auto max-w-3xl p-4 md:p-0">
        <article>
          ...
          <p className="my-8 font-lato text-xl tracking-wide text-justify">
            ...
            is absolutely a tourist trap, but if you are in the area checking
            out the Badlands, you should check it out. Advertisements telling us
            of the giant Jackalope, five cent cup of coffee, Western themed
            souvenirs, and a giant dinosaur piqued our interest. We learned that
            it became as popular as it is today by simply offering a free glass
            of iced water to tourists.
          </p>
          <p className="my-8 font-lato text-xl tracking-wide text-justify">
            ...
            transported us straight into the Wild West. There were stores full
            of trinkets, homemade fudge, Christmas ornaments, beautiful Western
            ...
            “Nothing breakable in the trailer!” Oh, and the fact that we
            literally live in a tiny travel trailer now.
          </p>
          ...
          <p className="my-8 font-lato text-xl tracking-wide text-justify">
            It is fun to browse the stores and try some fudge, but the magic is
            in the Backyard. I rode a Jackalope, a majestic creature that is a
